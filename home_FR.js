...
const addOptionsValueToProfessionsSelect = (professionsArray) => {
    ...
    for (var i = 0; i < professionsArray.length; i++) {
        var option = document.createElement("option");
        option.value = professionsArray[i][0];
        option.text = professionsArray[i][1];
    ...
    switch(evt.target.value) {
        ...
        case "AB": 
            licensingArrayProvinceSpecifiedList = ["Alberta College of Combined Laboratory and X-Ray Technologists",
             ...
             professionsOptionsList = [
                ...
                ["Registered Psychiatric Nurse", "Registered Psychiatric Nurse"],
        ...
        case "PE": 
          ...
          case "SK": 
            licensingArrayProvinceSpecifiedList = ["Chiropractors' Association of Saskatchewan",
                ...
                "None of the above"];
             professionsOptionsList = [["Audiologiste", "Audiologist"],
                "Chiropractrice ou chiropracteur",
                "Assistante ou assistant dentaire",
                "Hygiéniste dentaire",
                "Technicienne ou technicien dentaire",
                "Thérapeute dentaire",
                "Chiropractrice ou chiropracteur",
                "Denturologiste",
                "Diététiste",
                "Conseillère ou conseiller d'orientation",
                "Infirmière or infirmier auxiliaire",
                "Technologue de laboratoire médical",
                "Technologue en radiologie médicale",
                "Sage-femme",
                "Médecin naturopathe",
                "Infirmière practicienne ou infirmier praticien",
                "Ergothérapeute",
                "Opticienne ou opticien",
                "Optométristes",
                "Auxiliaire médical",
                "Pharmacist",
                "Médecin",
                ...
                "Psychologue",
                "Loisirs thérapeute",
                "Infirmière ou infirmier autorisés",
          ...
          case "ON": 
            licensingArrayProvinceSpecifiedList = ["College of Audiologists and Speech-Language Pathologists of Ontario",
                ...
                "Canadian Therapeutic Recreation Association",
                "None of the above"];
             professionsOptionsList = ["Acupunctrice ou acupuncceur",
                ["Audiologiste", "Audiologist"],
                "Chiropractrice ou chiropracteur",
                "Hygiéniste dentaire",
                "Technicienne ou technicien dentaire",
        ...
        case "QC": 
            licensingArrayProvinceSpecifiedList = ["Association canadienne des loisirs thérapeutiques",
             ...
             professionsOptionsList = [
                ...
                ["Respiratory Therapist", "Inhalothérapeute"],
        ...
        case "YT" :
            licensingArrayProvinceSpecifiedList = ["Canadian Therapeutic Recreation Association",
             ...
             professionsOptionsList = [
                ["Chiropractrice ou chiropracteur", "Chiropractor"],
                ["Hygiéniste dentaire", "Hygiéniste dentaire"], 
                ["Thérapeute dentaire", "Dental Therapist"],
                ["Dentiste", "Dentist"],
                ["Denturologiste", "Denturist"],
                ["Infirmière or infirmier auxiliaire", "Licensed Practical Nurse"],
                ...
                ["Loisirs thérapeute", "Recreation Therapist"],
                ["Infirmière ou infirmier autorisés", "Registered Nurse"],
                ["Registered Psychiatric Nurse", "Infirmières et infirmiers psychiatriques autorisés"],
                ["None of the above", "None of the above"]
             ];
            break;
        case "NT" :
